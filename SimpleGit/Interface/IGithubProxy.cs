...
namespace SimpleGit.Interface
{
    ...
    public interface IGithubProxy : IDisposable
    {
        ...
        /// </summary>
        Task<GitCommitHistory> GetGithubCommitHistory(string user, string password, long repositoryId, string branchName, string sha1, string sha2);
        ...
        Task<GitRepositoryRemote?> GetGithubRepository(string user, string password, long repositoryId);
